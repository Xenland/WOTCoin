...
$wot_header_config["title"] = "Transaction Details";
wot_header();
?>			
						<?php 
						$wot_leftside_menu["selected"] = -1;
						$wot_leftside_menu["selected_title"] = "Transaction Information";
						...
						<div id="bodyContent">
								...
								?>
							<div class="contbox1Container" style="width:99.99%;margin-top:7em;">
								<h3 style="text-align:center;padding-bottom:0.5em;font-size:120%;"></h3>
								...
								?>
									<div class="contentBox" style="margin-top:1em;">
										...
										<br/>
										<br/>
										<form action="/view_transaction.php?id=<?php echo $tx_id;?>&act=signmessage" method="post">
...
---END MESSAGE---</textarea><br/><br/>
											<form action="/view_transaction.php?id=<?php echo $tx_id;?>&act=signfullfilledmessage" method="post">
...
---END MESSAGE---</textarea>
											<form action="/view_transaction.php?id=<?php echo $tx_id;?>&act=signswimfulfilledmessage" method="post"/>
												<br/>
